...
public class Test0 {
	 ...
	 ExtentReports extent;
		...
		void  test_01() throws IOException
		{
				...
				Object value0 = formatter.formatCellValue(sheet.getRow(0).getCell(0));
				Object value1 = formatter.formatCellValue(sheet.getRow(0).getCell(1));
				Object value2 = formatter.formatCellValue(sheet.getRow(0).getCell(2));
				Object value3 = formatter.formatCellValue(sheet.getRow(0).getCell(3));
